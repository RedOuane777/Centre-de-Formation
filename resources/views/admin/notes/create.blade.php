...
@else
<form action="{{ route('admin.notes.store', $examen->id) }}" method="POST">
    @csrf
    ...
    <div class="mt-3">
        <button class="btn btn-success"><i class="bi bi-check-circle me-1"></i>Enregistrer les notes</button>
        <a href="{{ route('admin.examens.index') }}" class="btn btn-secondary">Retour</a>
    </div>
</form>
@endif
